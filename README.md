...
- **Billing Model**: Fetches are billed (0.1 ICP + network fee) from user deposits, forwarded to a beneficiary (customizable) to fund cycles.
...
- Enter ID (e.g., 138924).
- Confirm fee (0.1 ICP + 0.0001 network).
